...
UPDATE media 
SET created_at = '1982-11-01 11:34:46'
WHERE id = 1;

UPDATE media 
SET created_at = '1982-01-01 11:34:46'
WHERE id = 2;

UPDATE media 
SET created_at = '1982-12-01 11:34:46'
WHERE id = 3;
...
UPDATE media 
SET created_at = '1982-10-01 11:34:46'
WHERE id = 5;
...
SELECT
    ...
    MONTHNAME(created_at) AS month_name, -- Январь, Июнь 
